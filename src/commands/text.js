...
var TextBlock = P(Node, function(_, super_) {
  ...
  _.latex = function() {
    ...
    return this.ctrlSeq + '{' + contents.replace(/[{}]/g, '\\$&') + '}';
  };
  _.html = function() {
    return (
...
LatexCmds.label = LatexCmds.labell = // Need this for plainTeXt, feel free to replace labell with label
...
LatexCmds.cite = makeTextBlock('\\cite', '', 'span', 'class="citation mq-text-mode"')
